<?php
/**
 * RoostOfficeList Listing
 * @author  Franklys Guimaraes
 */
class RoostOfficeList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('<strong> BUSQUE SEUS SERVIÇOS</strong>');
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RoostOfficeForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['RoostOfficeForm', 'onEdit'], ['id'=>'{id}']);

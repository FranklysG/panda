<?php
/**
 * RoostProviderList Listing
 * @author  Franklys Guimaraes
 */
class RoostProviderList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RoostProviderForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['RoostProviderForm', 'onEdit'], ['id'=>'{id}']);

<?php
/**
 * RoostBrandList Listing
 * @author  Franklys Guimaraes
 */
class RoostBrandList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RoostBrandForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['RoostBrandForm', 'onEdit'], ['id'=>'{id}']);

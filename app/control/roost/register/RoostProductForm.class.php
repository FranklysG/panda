<?php
/**
 * RoostProductForm Form
 * @author  Franklys Guimaraes
 */
class RoostProductForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // $this->form->addActionLink(_t('Back'),  new TAction(['RoostProductList', 'onReload']), 'fa:arrow-circle-left red');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['RoostProductList', 'onReload']));
        }

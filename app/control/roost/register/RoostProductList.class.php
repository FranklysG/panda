...
/**
 * RoostProductList Listing
 * @author  Franklys Guimaraes
 */
class RoostProductList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RoostProductForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['RoostProductForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if(empty($verifyBrand)){
                $pos_action = new TAction(['RoostBrandList', 'onReload']);

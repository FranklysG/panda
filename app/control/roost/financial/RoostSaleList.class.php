<?php
/**
 * RoostSaleList Listing
 * @author  Franklys Guimaraes
 */
class RoostSaleList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RoostSaleForm', 'onEdit']), 'fa:plus green');

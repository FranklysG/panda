<?php
/**
 * RoostInventoryForm Form
 * @author  Franklys Guimaraes
 */
class RoostInventoryForm extends TPage
{
    protected $form; // form
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['RoostInventoryList', 'onReload']));
        }

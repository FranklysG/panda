<?php
/**
 * RestaurantEmployeeList Listing
 * @author  Franklys Guimaraes
 */
class RestaurantEmployeeList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RestaurantEmployeeForm', 'onEdit']), 'fa:plus green');

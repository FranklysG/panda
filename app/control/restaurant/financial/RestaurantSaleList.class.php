<?php
/**
 * RestaurantSaleList Listing
 * @author  Franklys Guimaraes
 */
class RestaurantSaleList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RestaurantSaleForm', 'onEdit']), 'fa:plus green');

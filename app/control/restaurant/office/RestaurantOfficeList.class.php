<?php
/**
 * RestaurantOfficeList Listing
 * @author  Franklys Guimaraes
 */
class RestaurantOfficeList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RestaurantOfficeForm', 'onEdit']), 'fa:plus green');

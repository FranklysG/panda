<?php
/**
 * RestaurantInventoryList Listing
 * @author  Franklys Guimaraes
 */
class RestaurantInventoryList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['InventoryForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['InventoryForm', 'onEdit'], ['id'=>'{id}']);

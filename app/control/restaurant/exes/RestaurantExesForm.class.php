<?php
/**
 * RestaurantExesForm Form
 * @author  Franklys Guimaraes
 */
class RestaurantExesForm extends TPage
{
    protected $form; // form
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['RestaurantExesList', 'onReload']));
        }

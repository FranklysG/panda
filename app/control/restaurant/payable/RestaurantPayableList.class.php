<?php
/**
 * RestaurantPayableList Listing
 * @author  Franklys Guimaraes
 */
class RestaurantPayableList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['RestaurantPayableForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['RestaurantPayableForm', 'onEdit'], ['id'=>'{id}']);

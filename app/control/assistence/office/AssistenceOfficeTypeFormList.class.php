<?php
/**
 * AssistenceOfficeTypeFormList Form List
 * @author  Franklys Guimaraes
 */
class AssistenceOfficeTypeFormList extends TPage
{
    protected $form; // form
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for OfficeType
            $repository = new TRepository('OfficeType');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new OfficeType($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new OfficeType;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('app'); // open a transaction
                $object = new OfficeType($key); // instantiates the Active Record

...
class AssistenceInventoryList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $html = new THtmlRenderer('app/resources/assistence/system_inventory_dashboard.html');
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['AssistenceInventoryForm', 'onEdit']), 'fa:plus green');

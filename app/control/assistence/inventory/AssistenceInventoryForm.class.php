<?php
/**
 * AssistenceInventoryForm Form
 * @author  Franklys Guimaraes
 */
class AssistenceInventoryForm extends TPage
{
    protected $form; // form
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['AssistenceInventoryList', 'onReload']));
        }

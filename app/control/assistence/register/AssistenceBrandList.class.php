<?php
/**
 * AssistenceBrandList Listing
 * @author  Franklys Guimaraes
 */
class AssistenceBrandList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Brand');
        $this->form->setFormTitle('<strong> BUSQUE SUAS MARCAS</strong>');
        ...
        $row->layout = ['col-sm-6','col-sm-2','col-sm-2'];
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['AssistenceBrandForm', 'onEdit']), 'fa:plus green');
        ...
        $column_updated_at = new TDataGridColumn('updated_at', 'ULITMA ATUALIZAÇÃO', 'right');
        ...
        $action1 = new TDataGridAction(['AssistenceBrandForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $repository = new TRepository('Brand');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('app'); // open a transaction with database
            $object = new Brand($key, FALSE); // instantiates the Active Record
        ...
        {
            new TMessage('warning', 'Existem produtos cadastrados com essa marca'); // shows the exception error message
            TTransaction::rollback(); // undo all pending operations
        }
    }

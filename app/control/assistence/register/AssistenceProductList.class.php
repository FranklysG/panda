...
/**
 * AssistenceProductList Listing
 * @author  Franklys Guimaraes
 */
class AssistenceProductList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink('Cadastrar novo', new TAction(['AssistenceProductForm', 'onEdit']), 'fa:plus green');
        
        // creates a Datagrid
        $this->datagrid = new BootstrapDatagridWrapper(new TDataGrid);
        $this->datagrid->style = 'width: 100%';
        $this->datagrid->datatable = 'true';
        $this->datagrid->enablePopover('Produto', "<img style='max-height: 300px' src='tmp/".TSession::getvalue('userunitid')."/{image}'>");
        ...
        $action1 = new TDataGridAction(['AssistenceProductForm', 'onEdit'], ['id'=>'{id}']);

<?php
/**
 * AssistenceProductForm Form
 * @author  Franklys Guimaraes
 */
class AssistenceProductForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // $this->form->addActionLink(_t('Back'),  new TAction(['AssistenceProductList', 'onReload']), 'fa:arrow-circle-left red');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['AssistenceProductList', 'onReload']));
        }

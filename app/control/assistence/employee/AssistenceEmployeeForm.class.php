<?php
/**
 * AssistenceEmployeeForm Form
 * @author  Franklys Guimaraes
 */
class AssistenceEmployeeForm extends TPage
{
    protected $form; // form
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', AdiantiCoreTranslator::translate('Record saved'), new TAction(['AssistenceEmployeeList', 'onReload']));
        }

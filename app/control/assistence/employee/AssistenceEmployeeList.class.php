<?php
/**
 * AssistenceEmployeeList Listing
 * @author  Franklys Guimaraes
 */
class AssistenceEmployeeList extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('<strong>LISTAGEM DE FUNCIONÁRIOS</strong>');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['AssistenceEmployeeForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['AssistenceEmployeeForm', 'onEdit'], ['id'=>'{id}']);
